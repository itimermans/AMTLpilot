...
class CarController(CarControllerBase, SecOCLongCarController, GasInterceptorCarController):
  ...
  def update(self, CC, CC_SP, CS, now_nanos):
    ...
    ## AMT : Try Stop n Go hack (https://github.com/ErichMoraga/openpilot/commit/4759891494b3f291e8f94093b98703e70937cc7b)
    ...
    if self.CP.openpilotLongitudinalControl:
      if self.frame % 3 == 0:
        ...
        if pcm_accel_cmd < 0.0 or not CC.longActive:
          self.permit_braking = True
